class Aicommit < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/suenot/aicommit/releases/download/v0.1.115/aicommit-macos-aarch64"
    ...
    on_intel do
      url "https://github.com/suenot/aicommit/releases/download/v0.1.115/aicommit-macos-x86_64"
